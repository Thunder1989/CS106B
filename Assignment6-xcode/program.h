...
/* Method: toString
 * Usage: program.toString(); program.toString(startLine, endLine);
 * -----
 * Prints out the program lines.  toString() prints out all lines.
 * toString(startLine, endLine) prints out the lines between startLine and endline, inclusive.
 */
    void toString();
    void toString(int startLine, int endLine);
...
private:
    ...
    struct Cell {
        ...
        Cell *link;                     // pointer to next line
    };
    
/* Instance variables */
    HashMap<int, Cell *> map;
    Cell *start;

 ...
 *
 *  1. ConstantExp   -- an double constant
...
/*
 * Method: eval
 * Usage: double value = exp->eval(context);
 * --------------------------------------
 ...
 * ---------------------
 * This subclass represents an double constant.
 */
...
/*
 * Method: getValue
 * Usage: double value = context.getValue(var);
 * -----------------------------------------

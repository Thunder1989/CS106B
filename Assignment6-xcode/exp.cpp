 ...
 * ---------------------------------
 * The ConstantExp subclass represents an double constant.  The eval
...
void EvaluationContext::setValue(string var, double value) {
   symbolTable.put(var, value);
}

double EvaluationContext::getValue(string var) {
...
void EvaluationContext::setCurrentLine(int line) {
    currentLine = line;
}
